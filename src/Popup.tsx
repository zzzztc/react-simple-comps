...
import { isMobile, isBrowser } from './helper/dom';
import clsx from 'clsx';
import { animationFast } from './consts/vars';
import useMount from './hooks/useMount';
import useForceUpdate from './hooks/useForceUpdate';
import { getTargetElement } from './helper/helper';
          ...
          <Transition in={visible} timeout={duration} unmountOnExit={unmountOnExit}>
            {(status) => (
              <StyledWrapper
                ...
                className={clsx('rsc-popup', className, position, status, position + '-' + status, {
                  mobile: isMobile,
                  pc: !isMobile,
                })}
              >
